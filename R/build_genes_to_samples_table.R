build_genes_to_samples_table <- function(all_samples_with_patient_ids, rna_seq_expr_matrix, genes, samples) {
  ...
  cat_genes_to_samples_status("Removing total-duplicates so there is a smaller data set to work with.")
