(function() {
  ...
  # test_that("old_create_gene_expression_lookup returns the right values from the sample matrix",{
  #   sample_matrix <- feather::read_feather("../test_data/RNASeqV2Sample.feather")
  #   lookup <- old_create_gene_expression_lookup(sample_matrix)
  ...
  # })
  # test_that("old_create_gene_expression_lookup returns NA when gene_id or sample_id do not exist in the data",{
  #   sample_matrix <- feather::read_feather("../test_data/RNASeqV2Sample.feather")
  #   lookup <- old_create_gene_expression_lookup(sample_matrix)
