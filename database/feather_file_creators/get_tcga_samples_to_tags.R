...
tcga_study_samples_to_tags <- "TCGA_Study" %>%
  get_tcga_samples_to_tags %>%
  feather::write_feather("../../feather_files/samples/tcga_study_samples_to_tags.feather")

tcga_subtype_samples_to_tags <- "TCGA_Subtype" %>%
  get_tcga_samples_to_tags %>%
  feather::write_feather("../../feather_files/samples/tcga_subtype_samples_to_tags.feather")

immune_subtype_samples_to_tags <- "Immune_Subtype" %>%
  get_tcga_samples_to_tags %>%
  feather::write_feather("../../feather_files/samples/immune_subtype_samples_to_tags.feather")
