...
- ### publications
  ...
  Each row describes a publication. [publications](#publications).
...
- [publications](#publications)
  ...
  - `journal` - The journal published in. (a character)
    
  - `first_author_last_name` - The last name of the first author. (a character)
  
  - `year` - The year published. (an integer)
    
  - `title` - The name of the publication. (a character)
