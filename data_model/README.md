...
- [publications](#publications)
  ...
  - `id` - A unique identifier for the specific publication. This is an integer that is generated by the database. (an integer)

  - `pubmed_id` - The unique id at "https://pubmed.ncbi.nlm.nih.gov/{id}". (an integer)

  - `journal` - The journal published in. (a string)

  - `first_author_last_name` - The last name of the first author. (a string)

  - `year` - The year published. (an integer)

  - `title` - The name of the publication. (a string)
...
- [publications_to_genes](#publications_to_genes)
  ...
  - `publication_id` - The database identifier of a publication. Relates to the `id` field in a row in the [publications](#publications) main table. (an integer)
...
- [nodes](#nodes)
  ...
  - `name` - The unique name of the node. Usually `<dataset>_<network>_<n>`

  - `dataset_id` - The database identifier of the dataset associated with this node. Relates to the `id` field in a row in the [datasets](#pathways) main table. (an integer)
...
- [edges](#edges)
  ...
  - `name` - The unique name of the edge. Usually `<dataset>_<network>_<n>`
